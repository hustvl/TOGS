...
def render(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None, view_time= None):
    """
    Render the scene. 
    ...
    #panyi = net(time_opacity,view_time2)
    #print((view_time-x3)*y4-(view_time-x3)*y3)
    panyi = panyi.unsqueeze(1)

    #print(view_time)
    #print(time_opacity[800])
    #print(opacity[0],panyi[0])
    #print(x1,x2,x3,x4)
    #for i in [4000,5000,6000,7000,8000,9000]:
        #print(time_opacity[i])
        #print(means3D[i])
